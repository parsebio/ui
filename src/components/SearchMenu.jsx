    ...
    <Menu>
      ...
      </Menu.Item>
      {
        Object.keys(filteredOptions).map((category) => [
          filteredOptions[category].length > 0 ? <Menu.Item><Divider orientation='left' plain>{category || ''}</Divider></Menu.Item> : null,
          filteredOptions[category].map((item) => renderMenuItem(

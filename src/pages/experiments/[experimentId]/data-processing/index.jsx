...
const DataProcessingPage = ({ experimentId }) => {
  ...
  const renderContent = () => {
    ...
    const stepWarningMessage = `Sample${pluralWarnings ? 's' : ''} ${pluralWarnings ? 'have' : 'has'} warnings in this filtering step. Check the QC plots for ${pluralWarnings ? 'those samples' : 'that sample'} and consider adjusting the thresholds.`;
    //
    return (

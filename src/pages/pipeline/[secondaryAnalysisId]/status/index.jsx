...
const AnalysisDetails = ({ secondaryAnalysisId }) => {
  ...
  const setupReports = useCallback(async () => {
    ...
    const { kit, pairedWt } = secondaryAnalysis;
    const outputOptions = {};
    ...
    if (hasWT) {
      ...
      outputOptions['Whole Transcriptome'] = wtOptions;
    }

    if (hasImmune) {
      outputOptions['Immune Profiling'] = [
        { label: 'Unfiltered', key: 'unfiltered', description: 'Unfiltered output files' },
        { label: 'Filtered', key: 'filtered', description: 'Filtered output files' },
        { label: 'Reports', key: 'reports', description: 'Reports generated by the pipeline' },
        { label: 'All files', key: 'all', description: 'All output files' },
      ];
    }

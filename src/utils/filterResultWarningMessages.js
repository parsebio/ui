export default {
  ...
  CLUSTERING_BAD_ALLOC: '\u26A0\uFE0F The clustering step failed due to a memory allocation error. To resolve this, consider switching to Scanpy in the Data Integration step or adjusting filtering thresholds in one or more of the previous quality control steps (steps 1–5).',
};

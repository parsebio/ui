...
export default {
  ...
  ERROR_READ_NUMBER_NOT_IN_NAME: 'File name must include "_R1" or "_R2" (its read number).',
  ERROR_TOO_MANY_READS_IN_NAME: 'File name can\'t contain "_R1" or "_R2" more than once.',

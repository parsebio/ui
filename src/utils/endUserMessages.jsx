...
export default {
  ...
  ERROR_MORE_FILES_THAN_SUBLIBRARIES: 'You have uploaded more pairs of FASTQ files than the specified number of sublibraries. Please check the inputed number of sublibraries or contact support about concatenating your FASTQ files.',
  ERROR_LESS_FILES_THAN_SUBLIBRARIES: "You have uploaded less pairs of FASTQ files than the specified number of sublibraries. Please check the inputed number of sublibraries or make sure your FASTQ files haven't been concatenated.",

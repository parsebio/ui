...
const fileUploadUtils = {
  ...
  [sampleTech.PARSE]: {
    ...
    fileUploadParagraphs: [
      'For a bulk upload, directly upload the single folder generated by the Parse\'s pipeline.',
      'Files inside the folder "all-samples" ("all-well" in previous versions) are not supported currently and will be ignored.',
